<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold mb-4 text-gray-800">Record New Fund Transaction</h2>
        ...
        <form wire:submit.prevent="createFund" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
            ...
            <div>
                ...
                <select wire:model="type" id="type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2 border">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No funds recorded yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
