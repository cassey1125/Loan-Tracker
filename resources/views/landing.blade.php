        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center">
                    <span class="text-2xl font-bold text-blue-900 tracking-tight">LoanTracker</span>
                </div>
                    ...
                    @if (Route::has('login'))
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="bg-blue-600 text-white px-5 py-2.5 rounded-full font-medium transition shadow-lg shadow-blue-500/30">Get Started</a>
                            @endif
                        @endauth
                    @endif
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center max-w-3xl mx-auto">
                <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-6">
                    ...
                    <span class="block text-blue-600">Confidence & Clarity</span>
                </h1>
                ...
                <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center gap-4">
                    @auth
                        <a href="{{ route('dashboard') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 md:py-4 md:text-lg md:px-10 shadow-xl shadow-blue-500/20 transition-all">
                            Go to Dashboard
                        </a>
                    @else
                        <a href="{{ route('register') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 md:py-4 md:text-lg md:px-10 shadow-xl shadow-blue-500/20 transition-all">
                            Start Tracking Now
                        </a>
                    @endauth
    ...
    <div class="bg-white py-16 sm:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-base font-semibold text-blue-600 tracking-wide uppercase">Interface</h2>
            ...
            <div class="space-y-24">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                    ...
                    <div class="mt-10 lg:mt-0 relative group">
                        <div class="absolute -inset-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg blur opacity-20 transition duration-1000"></div>
                        <img class="relative rounded-lg shadow-2xl border border-gray-200 w-full" src="{{ asset('images/image1.png') }}" alt="Dashboard Preview" loading="lazy" decoding="async">
                    </div>
                </div>
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center lg:flex-row-reverse">
                    ...
                    <div class="mt-10 lg:mt-0 lg:order-1 relative group">
                        <div class="absolute -inset-2 bg-gradient-to-r from-blue-500 to-teal-500 rounded-lg blur opacity-20 transition duration-1000"></div>
                        <img class="relative rounded-lg shadow-2xl border border-gray-200 w-full" src="{{ asset('images/image2.png') }}" alt="Borrower Management" loading="lazy" decoding="async">
                    </div>
                </div>
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
                    ...
                    <div class="mt-10 lg:mt-0 relative group">
                        <img class="relative rounded-lg shadow-2xl border border-gray-200 w-full" src="{{ asset('images/image3.png') }}" alt="Payment Tracking" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </div>
